...
This repository contains my Jupyter Notebook submission for **ECE 2112: Advanced Computer Programming and Algorithms – Experiment 1**, covering three Python problems:
**Alphabet Soup**, **Emoticon**, and **Unpacking a List**.

> Source of problems: *EXPERIMENT 1 - Introduction to Python Programming.pdf*
...
```
.
├─ 2ECEB_LUCAS_PA1.ipynb   # Jupyter notebook with solutions
